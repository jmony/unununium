 ...
 */
PyAPI_FUNC(PyObject *) PyTasklet_Become(PyTaskletObject *self, PyObject *retval);
 ...
 * It is either NULL, or Py_UnwindToken, and we leave eval_code.
 */
PyAPI_FUNC(PyObject *) PyTasklet_Capture(PyTaskletObject *self, PyObject *retval);
/* PyUnwindToken = success  NULL = failure */
 ...
 * if nobody is listening, you will get blocked and scheduled.
 */
PyAPI_FUNC(int) PyChannel_SendException(PyChannelObject *self, PyObject *klass, PyObject *value);
/* 0 = success  -1 = failure */
PyAPI_FUNC(int) PyChannel_SendException_nr(PyChannelObject *self, PyObject *klass, PyObject *value);
/* 1 = soft switched  0 = hard switched  -1 = failure */
 ...
 */
PyAPI_FUNC(PyObject *) PyStackless_Call_Main(PyObject *func, PyObject *args, PyObject *kwds);

/*
 * Convenience: Run any method as the "main" Python function.
 */
PyAPI_FUNC(PyObject *) PyStackless_CallMethod_Main(PyObject *o, char *name, char *format, ...);
