...
the system memory cache is /not/ maintained automaticaly by SNAP Graphics,
...
typedef struct {
    ...
    void *          (NAPIP MapDrawBuffer)(N_int32 mapIndex,N_int32 offset,N_int32 stride,N_int32 height);
    } GA_initFuncs;
